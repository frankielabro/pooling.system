...
namespace UserPoolingApi.Migrations
{
    ...
    [Migration("20180613024156_added icollection certification in user")]
    partial class addedicollectioncertificationinuser
    {
            ...
            modelBuilder.Entity("UserPoolingApi.Models.Skill", b =>
                {
                    b.HasOne("UserPoolingApi.Models.SkillType", "SkillType")
                        .WithOne("Skill")
                        .HasForeignKey("UserPoolingApi.Models.Skill", "SkillTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
